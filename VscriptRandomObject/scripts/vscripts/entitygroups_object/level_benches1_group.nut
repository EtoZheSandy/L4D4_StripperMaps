		...
		SpawnTables =
		{
			stair1 = 
			{
				SpawnInfo =
				{
					...
					mins = Vector( -1, -44, -1 )
					boxmins = Vector( -1, -44, -1 )
					maxs = Vector( 70, 44, 0 )
					boxmaxs = Vector( 70, 44, 0 )
					initialstate = "1"
					BlockType = "3"
			...
			unnamed1 = 
			{
				SpawnInfo =
				{
					...
					skin = "0"
					solid = "6"
					origin = Vector( -8.02709, 0, 22.5908 )
				}
			}
			unnamed2 = 
			{
				SpawnInfo =
				{
					...
					skin = "0"
					solid = "6"
					origin = Vector( 2.97291, 4, 43.5908 )
				}
			}
			unnamed3 = 
			{
				SpawnInfo =
				{
					...
					skin = "0"
					solid = "6"
					origin = Vector( 9.22495, 0, 31.703 )
				}
			}
			unnamed4 = 
			{
